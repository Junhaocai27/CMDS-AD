...
# 2. Locate the release root so the local utility package is importable.
project_root = os.path.dirname(current_dir)

# 3. Add the release root to the module search path.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', required=False, default="./data/raw/mvtec_3d", type=str, help='The root path of the MVTec 3D-AD. The preprocessing is done inplace (i.e. the preprocessed dataset overrides the existing one)')
