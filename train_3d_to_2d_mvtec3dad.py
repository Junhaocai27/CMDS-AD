...
def get_args():
    ...
    parser.add_argument("--class_name", type=str, default="bagel", help="Object category")
...
CONFIG = {
    ...
    "ckpt_dir": os.path.join(args.checkpoint_root, f"checkpoints_dual_3dto2d_{args.class_name}_{args.shots}shot"),
